...
- (void)setUploadProgressDelegate:(id)newDelegate
{
	...
	[self resetProgressDelegate:&uploadProgressDelegate_t];
...
- (void)setDownloadProgressDelegate:(id)newDelegate
{
	...
	[self resetProgressDelegate:&downloadProgressDelegate_t];
}
...
- (void)request:(ASIHTTPRequest *)request didReceiveBytes:(long long)bytes
{
	...
	if ([self downloadProgressDelegate]) {
        id downloadProgressDelegate_t = downloadProgressDelegate;
		[ASIHTTPRequest updateProgressIndicator:&downloadProgressDelegate_t withProgress:[self bytesDownloadedSoFar] ofTotal:[self totalBytesToDownload]];
	}
}
...
- (void)request:(ASIHTTPRequest *)request didSendBytes:(long long)bytes
{
	...
	if ([self uploadProgressDelegate]) {
        id uploadProgressDelegate_t = uploadProgressDelegate;
		[ASIHTTPRequest updateProgressIndicator:&uploadProgressDelegate_t withProgress:[self bytesUploadedSoFar] ofTotal:[self totalBytesToUpload]];
	}
}
