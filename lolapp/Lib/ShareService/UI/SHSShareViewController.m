...
{      
    ...
    {
        SHSMoreViewController *moreController=[[SHSMoreViewController alloc] init];
...
//                [alert release];
            ...
            UINavigationController *navController=[[UINavigationController alloc] initWithRootViewController:[[SHSRedirectViewController alloc] initWithUrl:url]];
